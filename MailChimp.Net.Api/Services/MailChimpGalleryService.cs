...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpGalleryService : MailChimpService
    {
        ...
        public ServiceResponse<List<GalleryFile>> List(string type = null, int start = 0, int limit = 25, string sortBy = "time", string sortDirection = "desc", string searchTerm = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse<List<GalleryFile>>> ListAsync(string type = null, int start = 0, int limit = 25, string sortBy = "time", string sortDirection = "desc", string searchTerm = null)
        {   
            // prepare URL
