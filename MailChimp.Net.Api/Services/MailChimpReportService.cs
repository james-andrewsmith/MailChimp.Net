...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpReportService : MailChimpService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ServiceResponse Abuse(string campaignID, int start = 0, int limit = 100, string since = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> AbuseAsync(string campaignID, int start = 0, int limit = 100, string since = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ServiceResponse Advice(string campaignID, int start = 0, int limit = 25, string since = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> AdviceAsync(string campaignID, int start = 0, int limit = 100, string since = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> BounceMessageAsync(string campaignID, Email email)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> ClickDetailAsync(string campaignID, int tid, int start = 0, int limit = 100, string sortField = "clicks", string sortDirection = "asc")
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> ClicksAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> DomainPerformanceAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> ECommerceOrdersAsync(string campaignID, int start = 0, int limit = 100, string since = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> EepUrlAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> GeoOpensAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> GoogleAnalyticsAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> MemberActivityAsync(string campaignID, List<Email> emails)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> NotOpenedAsync(string campaignID, int start = 0, int limit = 100)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> OpenedAsync(string campaignID, int start = 0, int limit = 100, string sortField = "opened", string sortDirection = "asc")
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> SentToAsync(string campaignID, string status = null, int start = 0, int limit = 100)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> ShareAsync(string campaignID, List<string> toEmail = null, int themeID = 0, string cssUrl = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> SummaryAsync(string campaignID)
        {            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> UnsubscribesAsync(string campaignID, int start = 0, int limit = 25)
        {            
