...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpUserService : MailChimpService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> InviteAsync(string email, Role role = Role.Viewer, string message = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> InviteResendAsync(string email)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> InviteRevokeAsync(string email)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> InvitesAsync()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> LoginRevokeAsync(string username)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse<List<User>>> LoginsAsync(string username)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse<User>> ProfileAsync(string username)
        {
