...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpHelperService : MailChimpService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> PingAsync()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse<AccountDetails>> AccountDetailsAsync(List<string> exclude = null)
        {            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> CampaignsForEmailAsync(Email email, string listID = null)
        {            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> ChimpChatterAsync(Email email, string listID = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> GenerateTextAsync(string type, string html, string campaignID, string userTemplateID, string baseTemplateID, string galleryTemplateID, string sourceUrl)
        {
            // get the url
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> InlineCssAsync(string html, bool stripCss = false)
        {            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> ListsForEmailAsync(Email email)
        {           
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse<List<Campaign>>> SearchCampaignsAsync(string query, int offset, string snipStart, string snipEnd)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> SearchMembersAsync(string query, string id = null, int offset = 0)
        {            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> VerifiedDomainsAsync(string query, string id = null, int offset = 0)
        {
