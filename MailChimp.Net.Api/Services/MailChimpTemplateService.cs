...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpTemplateService : MailChimpService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> AddAsync(string name, string html, int folderID = 0)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> DeleteAsync(int templateID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> InfoAsync(int templateID, string type = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> ListAsync(bool custom, bool gallery, bool basic, string category = null, string folderID = null, bool includeInactive = false, bool inactiveOnly = false)
        {
            var url = Urls.Template + "/info.json";
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> UnDeleteAsync(int templateID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<ServiceResponse> UpdateAsync(int templateID)
        {
