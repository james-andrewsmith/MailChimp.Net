...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpVipService : MailChimpService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse<List<Activity>>> ActivityAsync()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> AddAsync(string id, List<Email> emails)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> DeleteAsync(string id, List<Email> emails)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse<List<Vip>>> MembersAsync(string id, List<Email> emails)
        {
