...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpCampaignService : MailChimpService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> DeleteAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> PauseAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> ReadyAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> ReplicateAsync(string campaignID)
        {
            var url = Urls.Campaign + "pause.json";            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> ResumeAsync(string campaignId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> ScheduleBatchAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> SegmentTestAsync(string campaignId)
        {
            var url = Urls.Campaign + "pause.json";            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> SendAsync(string campaignID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> SendTestAsync(string campaignID, List<string> testEmails = null, Nullable<EmailType> sendType = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> TemplateContentAsync(string campaignId)
        {            
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> UnscheduleAsync(string campaignID)
        {            
            // get the url
        ...
        /// </summary>
        /// <returns></returns>
        public MailChimpServiceResponse Update(string campaignID, string name, List<string> value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> UpdateAsync(string campaignID, string name, List<string> value)
        {
            // get the url
