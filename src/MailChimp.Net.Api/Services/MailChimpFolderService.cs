...
namespace MailChimp.Net.Api.Services
{
    public sealed class MailChimpFolderService : MailChimpService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public MailChimpServiceResponse Add(string name, FolderType type)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse<List<Folder>>> ListAsync(FolderType type)
        {
        ...
        public MailChimpServiceResponse Update(int id, string name, FolderType type)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<MailChimpServiceResponse> UpdateAsync(int id, string name, FolderType type)
        {
